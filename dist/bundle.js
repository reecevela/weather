...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "body {\n  font-family: \"Roboto\", sans-serif;\n  background-color: #14171c;\n  color: #eee;\n  line-height: 1.5;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  min-height: 100vh;\n  margin: 0;\n  /*background-image: url('./bkg.svg');*/\n  background-position: center;\n  background-repeat: no-repeat;\n}\n\n.weather-dashboard {\n  display: grid;\n  grid-template-columns: repeat(2, 1fr);\n  gap: 0.5rem;\n  width: 100%;\n  max-width: 1200px;\n  padding: 1rem;\n  box-sizing: border-box;\n}\n\n.weather-card,\n.weather-row {\n  background-color: #1c1f24;\n  border-radius: 12px;\n  padding: 1rem;\n}\n\n.weather-card {\n  grid-column: span 2;\n}\n\n.weather-card label {\n  display: block;\n  margin-bottom: 0.5rem;\n  font-size: 1.2rem;\n  color: #eee;\n}\n\n.weather-card input#city-choice {\n  display: block;\n  width: 95%;\n  padding: 0.5rem;\n  border-radius: 4px;\n  border: 1px solid #2ffffc;\n  background-color: #1c1f24;\n  font-size: 1.2rem;\n  color: #eee;\n}\n\n.weather-card input[type=\"submit\"] {\n  display: block;\n  margin-top: 1rem;\n  padding: 0.5rem 1rem;\n  border-radius: 4px;\n  border: 1px solid #2ffffc;\n  background-color: #252a34;\n  color: #eee;\n  font-size: 1.2rem;\n  cursor: pointer;\n}\n\n.weather-card .location {\n  font-size: 1.5rem;\n  font-weight: bold;\n  color: #eee;\n}\n\n.weather-card .date-time {\n  font-size: 1.2rem;\n  color: #eee;\n}\n\n.weather-row {\n  display: flex;\n  align-items: stretch;\n  flex-flow: column nowrap;\n}\n\n.weather-row div {\n  display: flex;\n  justify-content: start;\n  align-items: center;\n  flex-direction: row;\n  margin-bottom: 0.5rem;\n}\n\n.weather-row div * {\n  margin: 0;\n  color: #eee;\n  padding-right: 8px;\n}\n\n.weather-row div span {\n  color: #2ffffc;\n}\n\n@media screen and (max-width: 712px) {\n  .weather-dashboard {\n    grid-template-columns: 1fr;\n  }\n  .weather-card {\n    grid-column: span 1;\n  }\n}\n", "",{"version":3,"sources":["webpack://./src/index.css"],"names":[],"mappings":"AAAA;EACE,iCAAiC;EACjC,yBAAyB;EACzB,WAAW;EACX,gBAAgB;EAChB,aAAa;EACb,uBAAuB;EACvB,mBAAmB;EACnB,iBAAiB;EACjB,SAAS;EACT,sCAAsC;EACtC,2BAA2B;EAC3B,4BAA4B;AAC9B;;AAEA;EACE,aAAa;EACb,qCAAqC;EACrC,WAAW;EACX,WAAW;EACX,iBAAiB;EACjB,aAAa;EACb,sBAAsB;AACxB;;AAEA;;EAEE,yBAAyB;EACzB,mBAAmB;EACnB,aAAa;AACf;;AAEA;EACE,mBAAmB;AACrB;;AAEA;EACE,cAAc;EACd,qBAAqB;EACrB,iBAAiB;EACjB,WAAW;AACb;;AAEA;EACE,cAAc;EACd,UAAU;EACV,eAAe;EACf,kBAAkB;EAClB,yBAAyB;EACzB,yBAAyB;EACzB,iBAAiB;EACjB,WAAW;AACb;;AAEA;EACE,cAAc;EACd,gBAAgB;EAChB,oBAAoB;EACpB,kBAAkB;EAClB,yBAAyB;EACzB,yBAAyB;EACzB,WAAW;EACX,iBAAiB;EACjB,eAAe;AACjB;;AAEA;EACE,iBAAiB;EACjB,iBAAiB;EACjB,WAAW;AACb;;AAEA;EACE,iBAAiB;EACjB,WAAW;AACb;;AAEA;EACE,aAAa;EACb,oBAAoB;EACpB,wBAAwB;AAC1B;;AAEA;EACE,aAAa;EACb,sBAAsB;EACtB,mBAAmB;EACnB,mBAAmB;EACnB,qBAAqB;AACvB;;AAEA;EACE,SAAS;EACT,WAAW;EACX,kBAAkB;AACpB;;AAEA;EACE,cAAc;AAChB;;AAEA;EACE;IACE,0BAA0B;EAC5B;EACA;IACE,mBAAmB;EACrB;AACF","sourcesContent":["body {\n  font-family: \"Roboto\", sans-serif;\n  background-color: #14171c;\n  color: #eee;\n  line-height: 1.5;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  min-height: 100vh;\n  margin: 0;\n  /*background-image: url('./bkg.svg');*/\n  background-position: center;\n  background-repeat: no-repeat;\n}\n\n.weather-dashboard {\n  display: grid;\n  grid-template-columns: repeat(2, 1fr);\n  gap: 0.5rem;\n  width: 100%;\n  max-width: 1200px;\n  padding: 1rem;\n  box-sizing: border-box;\n}\n\n.weather-card,\n.weather-row {\n  background-color: #1c1f24;\n  border-radius: 12px;\n  padding: 1rem;\n}\n\n.weather-card {\n  grid-column: span 2;\n}\n\n.weather-card label {\n  display: block;\n  margin-bottom: 0.5rem;\n  font-size: 1.2rem;\n  color: #eee;\n}\n\n.weather-card input#city-choice {\n  display: block;\n  width: 95%;\n  padding: 0.5rem;\n  border-radius: 4px;\n  border: 1px solid #2ffffc;\n  background-color: #1c1f24;\n  font-size: 1.2rem;\n  color: #eee;\n}\n\n.weather-card input[type=\"submit\"] {\n  display: block;\n  margin-top: 1rem;\n  padding: 0.5rem 1rem;\n  border-radius: 4px;\n  border: 1px solid #2ffffc;\n  background-color: #252a34;\n  color: #eee;\n  font-size: 1.2rem;\n  cursor: pointer;\n}\n\n.weather-card .location {\n  font-size: 1.5rem;\n  font-weight: bold;\n  color: #eee;\n}\n\n.weather-card .date-time {\n  font-size: 1.2rem;\n  color: #eee;\n}\n\n.weather-row {\n  display: flex;\n  align-items: stretch;\n  flex-flow: column nowrap;\n}\n\n.weather-row div {\n  display: flex;\n  justify-content: start;\n  align-items: center;\n  flex-direction: row;\n  margin-bottom: 0.5rem;\n}\n\n.weather-row div * {\n  margin: 0;\n  color: #eee;\n  padding-right: 8px;\n}\n\n.weather-row div span {\n  color: #2ffffc;\n}\n\n@media screen and (max-width: 712px) {\n  .weather-dashboard {\n    grid-template-columns: 1fr;\n  }\n  .weather-card {\n    grid-column: span 1;\n  }\n}\n"],"sourceRoot":""}]);
// Exports
...
/* harmony import */ var _cities__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./cities */ "./src/cities.js");
...
//all functions below
var handleCitySubmit = function handleCitySubmit(e) {
  e.preventDefault();
  var cityStateString = document.getElementById('city-choice').value;
  var _cityStateString$spli = cityStateString.split(", "),
    _cityStateString$spli2 = _slicedToArray(_cityStateString$spli, 2),
    cityInput = _cityStateString$spli2[0],
    stateInput = _cityStateString$spli2[1];
  // Find the city with that name
  var cityMatch = _cities__WEBPACK_IMPORTED_MODULE_4__.cities.find(function (city) {
    return city.city == cityInput && city.state == stateInput;
  });
...
function createWeatherDashboard(forecast, location) {
  ...
  cityForm.onsubmit = function (e) {
    return handleCitySubmit(e);
  };
}
function updateForecast(lat, _long) {
  var locationInput = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
  (0,_weather__WEBPACK_IMPORTED_MODULE_1__["default"])(lat, _long).then(function (data) {
